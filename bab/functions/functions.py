...
def compute_reduced_dataset(df,quantiles,QTLS,top_mktcap=True,no_companies_per_quantile=500):
    frames = []
    if top_mktcap == True:
...
def compute_holding_periods(df, QTLS):
...
def merge_holding_periods_on_returns(data,holding_periods,QTLS):
